...
def load_observation(
    ...
    rgb_img = Image.open(example_dir / "image_rgb.png")
...
def load_detections(
    ...
    # print('input_object_data', input_object_data)
...
def run_inference(
    ...
    # for zero shot
    # detections = load_detections_zero(zero_shot_bbox=[200, 96, 468, 360]).cuda()
